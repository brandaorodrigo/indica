...
CREATE TABLE IF NOT EXISTS `images` (
    `id` int(11) NOT NULL,
    `image_custom` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
    `date` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `users` (
    ...
    `image_logo` varchar(200) CHARACTER SET utf8 NOT NULL,
    `game` varchar(200) CHARACTER SET utf8 DEFAULT NULL,
